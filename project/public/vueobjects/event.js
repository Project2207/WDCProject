...
var modify_event = new Vue({
    ...
    data: {
        ...
        // event_start_day: days[event_start.getDay()],
        // event_start_date: event_start.getDate(),
        // event_start_month: months[event_start.getMonth()],
        // event_start_year: event_start.getFullYear(),
        // event_start_time: timeIn12hrFormat(event_start.getHours(), event_start.getMinutes()),
        // event_end_time: timeIn12hrFormat(event_end.getHours(), event_end.getMinutes()),
        event_start_day: "",
        event_start_date: "",
        event_start_month: "",
        event_start_year: "",
